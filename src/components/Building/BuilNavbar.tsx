...
import PropertyImage from "../../assets/image1.png";
import { Button } from "@mui/material";
import { useState, useEffect } from "react";
import filterImg from "../../assets/filter.png";
import BuilNav from "./BuilNav";
...
export default function BuilNavbar() {
      ...
      >
        <Toolbar>
          ...
          >
            ...
            <Typography color="white" sx={{ fontWeight: 600, color: "lightgrey" }}>
              Building A
            </Typography>
            <Typography color="white" sx={{ mx: 0.5 }}>
              &gt;
