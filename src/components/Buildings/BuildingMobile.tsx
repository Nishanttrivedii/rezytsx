              ...
              <table className="w-[95%] divide  -y divide-gray-200 border-separate border-spacing-y-3 md:m-4 lg:m-4 m-[10px] ">
                ...
                <tbody className="divide-y divide-gray-200">
                  {tableData.map((item, index) => (
                   ...
                   <div className="flex flex-row justify-between items-center">   <td style={{ lineHeight: '3px',color:'rgba(0, 0, 0, 0.8)' }} className="order-1 rounded-l-xl px-6 py-4 whitespace-nowrap text-sm font-sm "><div className="flex flex-row items-center gap-1"><img className="h-4 w-4" src={th} alt="" /> <div>Building {item.building}</div></div></td>
