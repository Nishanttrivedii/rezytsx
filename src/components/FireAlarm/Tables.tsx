      ...
      >
        {isSmallScreen ? (
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              <div style={{ display: "flex", alignItems: "center" }}>
                {parseInt(READINGS[0].REDETAIL.split(":")[1]) <= 25 ? (
                  <img src={RedTempImg} alt="Temperature" style={{ width: "20px", height: "20px" }} />
                ) : (
                  <img src={TempImage} alt="Temperature" style={{ width: "20px", height: "20px" }} />
                )}
            ...
            >
              <div style={{ display: "flex", alignItems: "center" }}>
                <img src={DropImage} alt="Humidity" style={{ width: "20px", height: "20px", marginRight: "0.5rem" }} />
            ...
            <Typography style={{ padding: "0.5rem" }}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div
                  style={{
                    backgroundColor: `${
                      STATUS[0].ONDETAIL === "ONLINE" ? "#00C17B" : "rgba(255, 153, 0, 1)"
                    }`,
                    padding: "0.5rem",
                    borderRadius: "5px",
                    width: "6rem",
          ...
          <thead>
            <tr>
              <th style={{ padding: "0.5rem", fontWeight: "400", flex: "0 1 100px" }}>{DEVICE_ID}</th>
              <th style={{ padding: "0.5rem", fontWeight: "400", flex: "1 1 200px" }}>{PROPERTY}</th>
              <th style={{ padding: "0.5rem", fontWeight: "400", flex: "1 1 150px" }}>{INSTALLED_DATE}</th>
              <th style={{ padding: "0.5rem", fontWeight: "400", flex: "1 1 300px" }}></th> 
              <th style={{ padding: "0.5rem", fontWeight: "400", flex: "1 1 280px" }}>
                <div style={{ display: "flex", alignItems: "center" }}>
                  <div
                    style={{
                      marginRight: "1rem",
              ...
              <th style={{ padding: "0.5rem", fontWeight: "400", flex: "1 1 120px" }}>
                <div
                  style={{
                    display: "flex",
                    alignItems: "center",
